...
For detailed architecture diagrams including error handling flow, circuit breaker state machine, and retry logic, see the [Production Features Architecture](../architecture/production-features.mdx) documentation.
