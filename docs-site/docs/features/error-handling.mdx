...
2. **Retry Logic** - Automatically retries transient errors with exponential backoff
...
CIRCUIT_BREAKER_WINDOW_SIZE=30000
CIRCUIT_BREAKER_OPEN_TIMEOUT=60000
```

See [Environment Variables](../configuration/environment-variables.mdx) for details.
